...
void AudioPolicyManagerBase::checkOutputForAllStrategies()
{
    ...
    checkOutputForStrategy(STRATEGY_MEDIA_SECOND);
...
audio_devices_t AudioPolicyManagerBase::getNewDevice(audio_io_handle_t output, bool fromCache)
{
    ...
    } else if (outputDesc->isStrategyActive(STRATEGY_MEDIA_SECOND)) {
        device = getDeviceForStrategy(STRATEGY_MEDIA_SECOND, fromCache);
...
AudioPolicyManagerBase::routing_strategy AudioPolicyManagerBase::getStrategy(
    ...
    case AudioSystem::MUSIC_SECOND:
        return STRATEGY_MEDIA_SECOND;
                                                             ...
                                                             bool fromCache)
{
    ...
    case STRATEGY_MEDIA_SECOND: {
        ...
        device = mDefaultOutputDevice;
        if (device == AUDIO_DEVICE_NONE) {
            ALOGE("getDeviceForStrategy() no device found for STRATEGY_MEDIA_SECOND");
        }
        } break;
